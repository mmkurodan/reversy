...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentOverlay.setBackground(createCommentOverlayBackground());
        int commentPad = dp(10);
        commentOverlay.setPadding(commentPad, commentPad, commentPad, commentPad);

        TextView commentLabel = new TextView(this);
        commentLabel.setText("対局コメント");
        applyDarkLabel(commentLabel);
        commentOverlay.addView(commentLabel);
        ...
        commentRow.setPadding(0, dp(8), 0, 0);
